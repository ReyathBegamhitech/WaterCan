      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Text('Order ${widget.order['orderId']} updated to $_selectedStatus', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w600)),
          ],
        ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SellerOrderCard(
                      ...
                      status: _selectedStatus, // Shows preview of new status!
                      buyerName: widget.order['buyerName'],
                      buyerPhone: widget.order['buyerPhone'],
                      quantity: widget.order['quantity'],
                      pricePerCan: widget.order['pricePerCan'],
