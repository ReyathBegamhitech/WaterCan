  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-space-lg pb-space-xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-space-sm">
          ...
          <div className="flex items-center gap-space-xs bg-surface-container-low p-1.5 rounded-full self-start md:self-auto">
              <button onClick={prefill} className="px-space-sm py-1 rounded-full font-label-sm text-label-sm text-primary hover:bg-surface-container transition-all flex items-center gap-1" type="button">
                  <span className="material-symbols-outlined text-[16px]">auto_fix_high</span> Demo Auto-fill
              </button>
              <div className="w-px h-4 bg-outline-variant/40"></div>
              <button onClick={simulateError} className="px-space-sm py-1 rounded-full font-label-sm text-label-sm text-error hover:bg-error-container/40 transition-all flex items-center gap-1" type="button">
                  <span className="material-symbols-outlined text-[16px]">bug_report</span> Simulate Error
              </button>
          </div>
      </div>
      ...
      <div className="bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden transition-all">
          <div className="p-space-lg bg-surface-container-low flex flex-col md:flex-row md:items-center justify-between gap-space-sm">
              ...
              <div className="flex items-center gap-space-xs self-start md:self-auto px-space-md py-1 rounded-full bg-surface-container-lowest shadow-xs text-on-surface-variant font-label-sm text-label-sm">
                  <span className="w-2 h-2 rounded-full bg-primary"></span>
                  <span>Step 1 of 1: Identity &amp; Auth</span>
              </div>
          </div>
